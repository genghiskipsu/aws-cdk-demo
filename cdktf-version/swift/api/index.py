...
from cdktf import TerraformAsset, TerraformOutput, AssetType
...
class SwiftApi(Construct):

    apiEndPoint: str
    
    def __init__(self, scope: Construct, id: str, table: DynamodbTable,):
        ...
        asset = TerraformAsset(self, "lambda-asset",
            path = Path.join(os.getcwd(), "swift/api/lambdaPy"),
        ...
        TerraformOutput(self, "endpoint_url", value=api.api_endpoint)
